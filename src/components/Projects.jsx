        ...
        <motion.div  
            ...
            <Tabs
                ...
                <Tab eventKey="project-5" title="FIXUP" > 
                    <div className='project-card'>
                        <div className='screen'>
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/mjP4Q32IJeM?controls=0?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                        </div>
                ...
                <Tab eventKey="project-6" title="Native App" > 
                    <div className='project-card'>
                        <div className='screen'>
                            <iframe width="560" height="100%" src="https://www.youtube.com/embed/CaVr6Rh2eu4?controls=0?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                        </div>
                        <div className='info-project'>
                            <h3>Contacts App</h3>
                            <p> This is a contact management application developed as part of a technical test for a Front-End position. The application allows importing, storing, editing, and deleting contacts using a Node.js server with Express and a PostgreSQL database on the backend, and a React Native client-side user interface on the frontend.</p>
                            <div className='github-link'>
                ...
                <Tab eventKey="project-2" title="Talker's">
                    <div className='project-card'>
                        <div className='screen'>
                            <iframe style={{ border: 'none' }} width="100%" height="315" src="https://www.youtube.com/embed/GN3KYw5b1n4?controls=0?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                        </div>
                        <div className='info-project'>
